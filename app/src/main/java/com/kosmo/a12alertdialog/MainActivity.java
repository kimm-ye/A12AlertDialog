...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAlertProgress.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                //버튼을 눌렀을때 대화상자가 열려있지 않으면 띄워준다.
                if(!progress.isShowing()){
                    progress.show();
                }

                //Handler객체를 통해 2초간 대기 후 창을 종료한다.
                //서버랑 연결하지 않아서 계속 돌아가므로 억지로 2초간 종료하게 만든거임
        ...
        순서
            ...
            3. Builder객체를 통해 대화창 설정시 setView() 생성자를 통해
                ...
                new AlertDialog.Builder(v.getContext())
                        ...
                        .setPositiveButton("화긴", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(MainActivity.this, sportTxt.getText(),
